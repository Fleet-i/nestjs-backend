...
import { StudentController } from 'apps/mongo-orm/student/student.controller';
import { StudentSchema } from 'apps/mongo-orm/student/student.scehma';
import { StudentService } from 'apps/mongo-orm/student/student.service';
@Module({
  imports: [
